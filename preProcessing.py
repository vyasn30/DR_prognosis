...
data_frame = pd.read_csv("data/aptos2019-blindness-detection/train.csv")
...
for id_code in tqdm(X_test):
    ...
    array = load_ben_color(path, sigmaX=30)
    image = Image.fromarray(array)
    image.save("data/aptos2019-blindness-detection/processed/test images/" + str(id_code) + ".png")
